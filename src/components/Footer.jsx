...
export default function Footer() {
  ...
  return (
    <footer className="custom-footer-root pt-3 pb-5 mt-auto">
      <div className="container pb-5 pb-lg-2">
        <div className="row text-start g-4">
          ...
          <div className="col-12 col-md-4 mb-2">
            <div className="d-flex align-items-center gap-2.5 mb-3">
              <div className="footer-icon-badge text-warning">
                <Building size={20} />
              </div>
            ...
            <p className="small lh-base mb-0" style={{ fontSize: '0.85rem', color: '#94a3b8' }}>
            ...
            <ul className="list-unstyled d-flex flex-column gap-2 mb-0">
              ...
              <li>
                <Link to="/join-agent" className="footer-link-item">
                  <UserPlus size={15} className="text-danger" />
          ...
          <div className="col-12 col-md-4">
            ...
            <div className="d-flex flex-column gap-2.5">
              ...
              {/* Email */}
              <a href={`mailto:${adminEmail}`} className="footer-contact-link d-flex align-items-center gap-2">
                <Mail size={15} className="text-warning flex-shrink-0" />
                <span className="text-truncate">{adminEmail}</span>
              </a>

              {/* Call */}
              <a href={`tel:${adminContact}`} className="footer-contact-link d-flex align-items-center gap-2">
                <Phone size={15} className="text-warning flex-shrink-0" />
                <span>+{adminContact}</span>
              </a>

              <div className="d-flex align-items-center gap-2 pt-2 mt-1 border-top border-white border-opacity-10">
                <ShieldCheck size={16} className="text-warning flex-shrink-0" />
        ...
        {/* Bottom Bar */}
        <div className="row align-items-center text-center g-2" style={{ fontSize: '0.75rem', color: '#64748b' }}>
          {/* Copyright */}
          ...
          {/* System Note */}
          <div className="col-12 col-md-4 text-md-end opacity-75" style={{ fontSize: '0.7rem' }}>
